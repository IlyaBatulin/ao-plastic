...
import { RfpRequestsClient } from "./rfp-requests-client"
...
export default function SuppliersPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Active RFPs */}
      <section className="py-20 bg-muted/30" id="tenders">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex flex-wrap items-center justify-between gap-4 mb-10">
            <div>
              <h2 className="text-3xl font-bold text-foreground">{t("suppliersPage.rfps.title")}</h2>
              <p className="mt-2 text-muted-foreground max-w-2xl">
                {t("suppliersPage.rfps.description")}
              </p>
            </div>
          </div>
          <RfpRequestsClient />
