...
const PeriodBlock22 = ({ period, image }: PeriodBlockProps) => {
  ...
  // Infographic visibility - appears below timeline
  ...
  const infographicX = useTransform(
    scrollYProgress,
    [0.4, 0.55],
    [100, 0]
  );
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-screen overflow-hidden bg-background">
        ...
        <div className="absolute right-[4%] md:right-[6%] top-[6%] bottom-[6%] w-[48%] flex flex-col gap-6">
          {/* Timeline */}
          <motion.div
