export const qualityPageContent = {
  ru: {
    heroTitle: "Менеджмент качества и сертификация",
    ...
    principlesTitle: "Принципы менеджмента качества",
    principles: [
      {
        title: "Ориентация на потребителя",
        description:
          "Понимание и выполнение требований заказчика, постоянное повышение его удовлетворённости.",
      },
      {
        title: "Лидерство руководства",
        description:
          "Руководство обеспечивает единство целей, создаёт условия для вовлечения сотрудников в достижение целей качества.",
      },
      {
        title: "Процессный подход",
        description:
          "Управление деятельностью и соответствующими ресурсами как процессами для повышения результативности.",
      },
      {
        title: "Постоянное улучшение",
        description:
          "Непрерывное совершенствование системы менеджмента качества и производственных процессов.",
      },
    ],
    stepsTitle: "Как мы обеспечиваем качество",
    qualitySteps: [
      {
        title: "Входной контроль сырья",
        description:
          "Проверка поступающего сырья по физико-химическим показателям в аккредитованной лаборатории.",
      },
      {
        title: "Контроль в процессе производства",
        description:
          "Операционный контроль параметров технологических процессов и промежуточная оценка качества.",
      },
      {
        title: "Приёмочные испытания",
        description:
          "Испытания готовой продукции на соответствие ГОСТ, ТУ и требованиям заказчиков.",
      },
      {
        title: "Внешние аудиты",
        description:
          "Регулярные аудиты органами по сертификации для подтверждения соответствия ISO и ГОСТ.",
      },
    ],
  ...
  en: {
    heroTitle: "Quality Management and Certification",
    ...
    principlesTitle: "Quality Management Principles",
    principles: [
      {
        title: "Customer Focus",
        description:
          "Understanding and meeting customer requirements and continually improving customer satisfaction.",
      },
      {
        title: "Leadership",
        description:
          "Management ensures unity of purpose and creates conditions for employee engagement in achieving quality objectives.",
      },
      {
        title: "Process Approach",
        description:
          "Managing activities and related resources as processes to improve effectiveness.",
      },
      {
        title: "Continual Improvement",
        description:
          "Continuous improvement of the quality management system and production processes.",
      },
    ],
    stepsTitle: "How We Ensure Quality",
    qualitySteps: [
      {
        title: "Incoming Raw Material Control",
        description:
          "Testing of incoming raw materials for physicochemical indicators in an accredited laboratory.",
      },
      {
        title: "In-Process Control",
        description:
          "Operational control of process parameters and interim quality assessment.",
      },
      {
        title: "Acceptance Testing",
        description:
          "Testing of finished products for compliance with GOST, technical specifications and customer requirements.",
      },
      {
        title: "External Audits",
        description:
          "Regular audits by certification bodies to confirm compliance with ISO and GOST standards.",
      },
    ],
    ...
    certificates: [
      ...
      },
      {
        ...
        description: "Confirmation that products meet established requirements.",
      },
      {
        href: "/docs/quality/diplom-abs.jpg",
        image: "/docs/quality/diplom-abs.jpg",
