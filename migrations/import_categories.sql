...
-- 1. АБС-пластики
('abs', 'abs', 'АБС-пластики', 'Широкий ассортимент АБС-пластиков для различных применений (автопром, приборостроение, медицина)', '/images/absiplast_main.png', 10, true),
-- 2. ПСВ и полистиролы
('polystyrene', 'polystyrene', 'Полистирол', 'Вспенивающийся и обычный полистирол различных марок для теплоизоляции и упаковки', '/images/polist_main.png', 20, true),
-- 3. Стирол
('styrene', 'styrene', 'Стирол', 'Высококачественный стирол мономерный для производства полистирола и сополимеров', '/stirol_main.png', 30, true),
...
('hoztovary', 'hoztovary', 'Товары народного потребления', 'Качественные изделия из пластика для дома и быта', '/images/hoztov_main.png', 70, true),
...
('machine-parts', 'machine-parts', 'Детали машиностроения', 'Широкий ассортимент пластиковых деталей для автомобильной промышленности и машиностроения', '/images/machine_main.png', 90, true),
...
('kors', 'kors', 'КОРС (кубовый остаток ректификации стирола)', 'Побочный продукт производства стирола, используется как топливо или компонент в ЛКМ', '/images/kors_bentol_main.png', 110, true),
